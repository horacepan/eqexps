...
def process_data():
    os.makedirs(os.path.join(PROJECT_DIR, 'data/original'), exist_ok=True)
    download('https://zenodo.org/record/2603256/files/train.h5?download=1', os.path.join(PROJECT_DIR, 'data/original/train.h5'))
    download('https://zenodo.org/record/2603256/files/val.h5?download=1', os.path.join(PROJECT_DIR, 'data/original/val.h5'))
    download('https://zenodo.org/record/2603256/files/test.h5?download=1', os.path.join(PROJECT_DIR, 'data/original/test.h5'))
